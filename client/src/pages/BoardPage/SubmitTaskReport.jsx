...
const SubmitTaskReport = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const filteredLinks = links.filter(l => l.name && l.url);
        const submitData = { ...data, links: filteredLinks };
        ...
        try {
            ...
            socketConnection.once("report-submitted", (data) => {
                ...
                localStorage.setItem("report", JSON.stringify(data?.reportData))
            ...
            socketConnection.emit("report-submit", submitData)

...
const TaskEdit = ({ close, columnName, currentTask, columnId }) => {
    ...
    return (
        <section className='fixed right-0 left-0 top-[70px] sm:top-0 bottom-0 flex flex-col items-center justify-center z-50 sm:bg-gray-800/75 bg-[#dbdbdb] overflow-y-auto'>
